...
shared(msg) actor class NFToken(
    ...
    private stable var logos_ : [Text] = _logos; // base64 encoded image
    private stable var name_ : Text = _name;
    private stable var symbol_ : Text = _symbol;
    private stable var desc_ : Text = _desc;
    private stable var owner_: Principal = _owner;
    private stable var mintFee_: Nat = _mintFee;
    ...
    public query func logos(): async [Text] {
        return logos_;
    };

    // public query function 
    public query func logosLength(): async Nat {
        return logos_.size();
    };

    // public query function 
    public query func logo(index:Nat): async Text {
        return logos_[index];
    };
    ...
    public query func mintFee(): async Nat {
        return mintFee_;
    };
